...
urlpatterns = [
    ...
    path('acceptFriendRequest/', Phone.userRequests, name= 'accept friend Request'),
    path('acceptFriendRequestM/', Phone.userRequests, name= 'accept friend Request'),
    path('hideFriendRequest/', Phone.userRequests, name= 'hide friend Request'),
    path('hideFriendRequestM/', Phone.userRequests, name= 'hide friend Request'),
